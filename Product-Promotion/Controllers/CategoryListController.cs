...
namespace catiga.Controllers
{
    public class CategoryListController : BaseController
    {
        ...
        {
            int digit12 = 12;
            List<Product> _urunler = db.Products.Where(x => x.IsDelete == false && x.Digit == digit12).ToList();
            return _urunler;
        }
        ...
        {
            int digit14 = 14;
            List<Product> _urunler = db.Products.Where(x => x.IsDelete == false && x.Digit == digit14).ToList();
            return _urunler;
        }
